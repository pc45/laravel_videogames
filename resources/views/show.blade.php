...
@section('content')
    <div class="container mx-auto px-4">
        <div class="game-details border-b border-gray-800 flex pb-12 flex-col lg:flex-row">
            <div class="flex-none">
                <img src="/animalcrossing.jpeg" alt="cover" class="" />
            </div>
            <div class="lg:ml-12 lg:mr-64">
                ...
                <p class="mt-12">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci assumenda atque cum distinctio dolor ducimus eos exercitationem facere fuga id iure laboriosam laborum, maxime minus modi nobis nulla officia porro possimus praesentium quis sequi sint soluta tempora tempore totam veritatis vitae. Ab, animi asperiores beatae cum eaque fugit harum itaque magnam molestias nulla, odio officia quis, quo repudiandae saepe ullam velit. Aliquam aliquid asperiores at atque beatae dicta dolore eos inventore mollitia nam omnis placeat possimus reiciendis saepe tempora, ut veniam voluptates, voluptatum. Accusantium, aliquam commodi consectetur deserunt dolorem ipsa, maxime molestias nemo nobis, praesentium quia similique vel velit voluptate.
                </p>
        ...
        <div class="images-container border-b border-gray-800 pb-12 mt-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mt-8">
                <div>
                    <a href="#">
                        <img src="/screenshot1.jpeg" alt="screenshot" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                </div>
                <div>
                    <a href="#">
            ...
            <div class="popular-games text-sm grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 xl:grid-cols-6 gap-12">
                <div class="game mt-8">
                    <div class="relative inline-block">
                        <a href="#">
                            <img src="/animalcrossing.jpeg" alt="game cover" class="hover:opacity-75 transition ease-in-out duration-150">
                        </a>

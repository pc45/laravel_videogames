        ...
        <div class="flex flex-col lg:flex-row my-10">
                ...
                <div class="recently-reviewed-container space-y-12 mt-8">
                    <div class="game bg-gray-800 rounded-lg shadow-md flex px-6 py-6">
                        <div class="relative flex-none">
                            <a href="#">
                                <img src="/animalcrossing.jpeg" alt="game cover" class="w-48 hover:opacity-75 transition ease-in-out duration-150">
                            </a>
            ...
            <div class="most-anticipated lg:w-1/4 mt-12 lg:mt-0">
                ...
                <div class="most-anticipated-container space-y-10 mt-8">
                    <div class="game flex">
                        <a href="#">
                            <img src="/animalcrossing.jpeg" alt="game cover" class="w-16 hover:opacity-75 transition ease-in-out duration-150">
                        </a>
                        <div class="ml-4">
                    ...
                    <div class="game flex">
                        <a href="#"><img src="/animalcrossing.jpeg" alt="game cover" class="w-16 hover:opacity-75 transition ease-in-out duration-150"></a>
                        <div class="ml-4">

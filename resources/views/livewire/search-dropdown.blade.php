<div class="relative" x-data="{ isVisible: true }" @click.away="isVisible = false">
    <input
        ...
        x-ref="search"
        type="search"
        class="bg-gray-800 text-sm rounded-full px-3 py-1 w-64 pl-8 focus:outline-none focus:ring"
    ...
    @if (strlen($search) >= 2)
        <div
            x-show="isVisible"
            class="absolute z-50 bg-gray-800 text-xs rounded w-64 mt-2" x-show.transition.opacity.duration.200="isVisible">
